...
export const toolCatalog = {
  ...
  "pdf-to-pdfa": {
    ...
    description: "Converte seu PDF para um formato PDF/A voltado à preservação e arquivamento.",
  ...
  "pdf-edit": {
    ...
    description: "Insere um texto editável em posicao predefinida no PDF usando o editor do iLovePDF.",
