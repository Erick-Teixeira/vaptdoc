...
const envSchema = z.object({
  ...
  ADMIN_SESSION_HOURS: defaultedInt(8, 1, 48),
  ADMIN_ELEVATION_MINUTES: defaultedInt(10, 2, 60),
  LOGIN_FAILURE_LIMIT: defaultedInt(5, 3, 20),
  LOGIN_LOCK_MINUTES: defaultedInt(15, 1, 1440),
  SECURITY_ALLOWED_ORIGINS: defaultedString(""),
  TURNSTILE_SITE_KEY: defaultedString(""),
  TURNSTILE_SECRET_KEY: defaultedString(""),
  TURNSTILE_ALLOWED_HOSTNAMES: defaultedString(""),
  TURNSTILE_REQUIRED: z.preprocess(emptyToUndefined, z.coerce.boolean().default(false)),
  BACKUP_ENCRYPTION_KEY: defaultedString(""),
  MALWARE_SCAN_BIN: defaultedString(""),
  MALWARE_SCAN_REQUIRED: z.preprocess(emptyToUndefined, z.coerce.boolean().default(false)),
  MAX_IMAGE_PIXELS: defaultedInt(40_000_000, 1_000_000, 200_000_000),
  MAX_ARCHIVE_ENTRIES: defaultedInt(2500, 10, 100_000),
  MAX_ARCHIVE_RATIO: defaultedInt(150, 2, 10_000),
