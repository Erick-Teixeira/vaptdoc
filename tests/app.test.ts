...
describe("app routes", () => {
  ...
  it("keeps account management in dedicated dashboard areas without overview duplication", async () => {
    ...
    expect(page.body).toContain('class="billing-modal account-pane-modal account-subscription-modal" id="account-subscription-modal"');
    expect(page.body).toContain('class="account-detail-page account-pane-modal" id="account-profile-modal"');
    expect(page.body).toContain('class="billing-page" id="billing-modal"');
